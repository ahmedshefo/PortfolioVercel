      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-20 md:mb-32">
          <motion.div
            ...
            className="inline-block px-6 py-2 bg-accent/20 rounded-full text-accent text-xs font-black uppercase tracking-[0.4em] mb-10"
          >
            Social Proof
          </motion.div>
          <motion.h2
            ...
            className="text-5xl sm:text-7xl md:text-8xl font-black text-gray-900 dark:text-white mb-8 italic tracking-tighter leading-[0.9]"
          >
            Industry <span className="text-accent underline decoration-accent/20 underline-offset-12">Voices</span>.
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0 }}
          ...
          >
            Trusted by directors and leads from world-class organizations.
          </motion.p>
        </div>
